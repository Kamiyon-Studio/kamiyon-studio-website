...
export function FocusRail({
  ...
  const onWheel = React.useCallback(
    (e: React.WheelEvent) => {
      const now = Date.now();
      // Debounce inertia scrolling (400ms lockout).
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[600px] w-full flex-col overflow-hidden overflow-x-hidden bg-neutral-950 text-white outline-none select-none",
        className,
      )}
